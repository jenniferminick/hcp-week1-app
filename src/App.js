...
const T = {
  en: {
    headerSub:"Week 1 — Facebook Groups Organic Strategy", saveExit:"Save & Exit", coachDashboard:"Coach Dashboard",
    homeTitle:"Turn Your Story Into", homeTitle2:"Jobs on Your Calendar",
    ...
    continueLabel:"Continue where you left off", weekChecklist:"Your Week 1 Checklist",
    writePost:"Write Post", writePostDesc:"Answer 15 questions. AI writes your trust-building post.",
    writePostSub:(n)=>`~8 min · ${n} of 15 answered`,
    postGroups:"Post in Groups", postGroupsDesc:"Find local Facebook groups and replicate your post to 10.",
    postGroupsSub:(n)=>`~15 min · ${n} of 10 groups posted`,
    workLeads:"Work Leads", workLeadsDesc:"Turn every like, comment, share, and DM into a booked job.",
    workLeadsSub:"~5 min · Scripts for every engagement type",
    writePostTitle:"Write Your Post", writePostSubtitle:"How would you like to answer the questions?",
    typeAnswers:"Type My Answers", typeAnswersDesc:"Fill in each question at your own pace.",
    talkThrough:"Talk Through It", talkThroughDesc:"Speak your answers. A coach guides you through every question.",
    back:"← Back", next:"Next →", of:"of", questionsAnswered:"questions answered",
    chapterComplete:"✓ Chapter complete!", answered:"answered", minWords:(n)=>`Minimum ${n} word${n!==1?"s":""}`,
    examplesTitle:"Examples from other Pros:", needInspiration:"Need inspiration? →", hideExamples:"Hide examples ▲",
    typeHere:"Type your answer here...",
    stopTitle:"Stop Here — Wait for Your Session", stopDesc:"Your answers are saved. Don't go further until your Business Coach is live with you.",
    ...
    findPhotoTitle:"Before Your Session — Find Your Photo", findPhotoDesc:"Based on your answers, here are personalized photo ideas just for you:",
    personalizing:"Personalizing your photo suggestions...", worksDoesnt:"Here's what works and what doesn't:",
    proTip:"Pro tip:", proTipText:"Pull up your camera roll right now and find 2-3 options. Have it ready to upload the moment your session starts.",
    readyText:"Ready? Only click this when your coach is with you.", readyBtn:"I'm in my session — let's continue →",
    goBackEdit:"← Go back and edit my answers",
    antiAdLabel:"✅ Anti-Ad — photos like these work great:", adLabel:"❌ Advertisement — avoid photos like these:",
    generatePost:"Generate My Post →", copyPost:"📋 Copy Post", copied:"✓ Copied!", regenerate:"↺ Regenerate",
    postCopied:"Post copied! 🎉", nextPickPhoto:"Next up: pick a photo.", choosePhoto:"📸 Choose My Photo →",
    stepGetPost:"Step 2 — Get & Copy Your Post",
    englishPost:"🇺🇸 English Post", spanishPost:"🇪🇸 Spanish Post (Preview)",
    spanishNote:"Preview only — the English post is what your coach will review.",
    writingPost:"Writing your post...",
    joinGroupTitle:"Step 1 — Join a Group", joinGroupSubtitle:"Find an active local Facebook group and join it. You only need one to start.",
    joined:"Joined — you're ready to post", didYouJoin:"Did you join the group?", iJoined:"I joined it →",
    choosePhotoTitle:"Step 3 — Choose Your Photo", choosePhotoSubtitle:"Pick one real photo of you. Your face needs to be clearly visible.",
    postItTitle:"Step 4 — Post It", postItSubtitle:"You're ready. Follow these steps exactly.",
    postSteps:["Open the Facebook group and tap Write something","Paste your copied post","Attach your photo","Tap Post"],
    submitTitle:"Step 5 — Submit for Review", submitSubtitle:"Paste your live post URL or upload a screenshot so your coach can verify it.",
    crossPostTitle:"Step 6 — Cross-Post to 9 More Groups", crossPostSubtitle:"Same post. Same photo. No edits. Hit 10 total.",
    ...
    howMany:"How many additional groups did you post in?", howManySub:"You already posted in 1 — tap how many more.",
    tenDone:"10 Groups Done! →", goalTitle:"WEEK 1 GOAL ACHIEVED", goalDesc:"10 groups. 10 posts. Mission accomplished.", openLeads:"Open Lead Engagement →",
    leadsTitle:"Session Complete — Now We Execute", leadsSubtitle:"Watch this training video before working your leads.",
    watchedBtn:"✓ I watched the video — show me the playbook", alreadyWatched:"Already watched?", skipBtn:"Skip →",
    notBuilt:"You haven't built your story yet.", notBuiltDesc:"Complete the 3 chapters to generate your AI-written post — or paste an existing post below.",
    writeMyPost:"✍️ Write My Post", pastePost:"Paste your Facebook post here...", usePost:"Use This Post →",
    devShortcuts:"Dev shortcuts", fillSample:"Fill Sample Answers", skipStop:"Skip to Stop Screen", skipGroups:"Skip to Groups", skipLeads:"Skip to Leads",
    searchCity:"What city or area do you serve?", cityPlaceholder:"e.g. East Nashville", search:"Search",
    coachAccess:"Coach Access", enterPasscode:"Enter passcode", incorrectPasscode:"Incorrect passcode.", enterDashboard:"Enter Dashboard", cancel:"Cancel",
    submitReview:"✅ Submit for Coach Review →", pasteOrUpload:"Paste a URL or upload a screenshot to continue",
    whyNeeded:"Why do we need this?", whyNeededDesc:"Your coach needs to see the live post before approving it. A URL or a screenshot — you only need one.",
    pasteUrl:"Option 1 — Paste your Facebook post URL", urlAccepted:"✓ URL accepted!",
    uploadScreenshot:"Option 2 — Upload a screenshot", tapUpload:"Tap to upload screenshot", screenshotAccepted:"✓ Screenshot accepted!",
  },
  es: {
    headerSub:"Semana 1 — Estrategia Orgánica de Grupos de Facebook", saveExit:"Guardar y Salir", coachDashboard:"Panel del Coach",
    homeTitle:"Convierte Tu Historia en", homeTitle2:"Trabajos en Tu Calendario",
    ...
    continueLabel:"Continuar donde lo dejaste", weekChecklist:"Tu Lista de la Semana 1",
    writePost:"Escribir Publicación", writePostDesc:"Responde 15 preguntas. La IA escribe tu publicación.",
    writePostSub:(n)=>`~8 min · ${n} de 15 respondidas`,
    postGroups:"Publicar en Grupos", postGroupsDesc:"Encuentra grupos locales de Facebook y replica tu publicación en 10.",
    postGroupsSub:(n)=>`~15 min · ${n} de 10 grupos publicados`,
    workLeads:"Trabajar Leads", workLeadsDesc:"Convierte cada like, comentario y mensaje en un trabajo reservado.",
    workLeadsSub:"~5 min · Scripts para cada tipo de engagement",
    writePostTitle:"Escribe Tu Publicación", writePostSubtitle:"¿Cómo quieres responder las preguntas?",
    typeAnswers:"Escribir Mis Respuestas", typeAnswersDesc:"Completa cada pregunta a tu propio ritmo.",
    talkThrough:"Hablar con el Coach", talkThroughDesc:"Di tus respuestas en voz alta. Un coach te guía pregunta por pregunta.",
    back:"← Atrás", next:"Siguiente →", of:"de", questionsAnswered:"preguntas respondidas",
    chapterComplete:"✓ ¡Capítulo completo!", answered:"respondidas", minWords:(n)=>`Mínimo ${n} palabra${n!==1?"s":""}`,
    examplesTitle:"Ejemplos de otros Pros:", needInspiration:"¿Necesitas inspiración? →", hideExamples:"Ocultar ejemplos ▲",
    typeHere:"Escribe tu respuesta aquí...",
    stopTitle:"Para Aquí — Espera Tu Sesión", stopDesc:"Tus respuestas están guardadas. No avances hasta que tu Coach esté en vivo contigo.",
    ...
    findPhotoTitle:"Antes de Tu Sesión — Encuentra Tu Foto", findPhotoDesc:"Basado en tus respuestas, aquí hay ideas de fotos personalizadas para ti:",
    personalizing:"Personalizando tus sugerencias de fotos...", worksDoesnt:"Esto es lo que funciona y lo que no:",
    proTip:"Consejo Pro:", proTipText:"Abre tu galería ahora mismo y encuentra 2-3 opciones. Tenla lista para subir en el momento en que empiece tu sesión.",
    readyText:"¿Listo? Solo haz clic cuando tu coach esté contigo.", readyBtn:"Estoy en mi sesión — continuemos →",
    goBackEdit:"← Volver y editar mis respuestas",
    antiAdLabel:"✅ Anti-Anuncio — fotos como estas funcionan bien:", adLabel:"❌ Anuncio — evita fotos como estas:",
    generatePost:"Generar Mi Publicación →", copyPost:"📋 Copiar Publicación", copied:"✓ ¡Copiado!", regenerate:"↺ Regenerar",
    postCopied:"¡Publicación copiada! 🎉", nextPickPhoto:"Siguiente: elige una foto.", choosePhoto:"📸 Elegir Mi Foto →",
    stepGetPost:"Paso 2 — Obtener y Copiar Tu Publicación",
    englishPost:"🇺🇸 Publicación en Inglés", spanishPost:"🇪🇸 Publicación en Español (Vista previa)",
    spanishNote:"Solo vista previa — la publicación en inglés es la que revisará tu coach.",
    writingPost:"Escribiendo tu publicación...",
    joinGroupTitle:"Paso 1 — Únete a un Grupo", joinGroupSubtitle:"Encuentra un grupo activo local de Facebook y únete. Solo necesitas uno para empezar.",
    joined:"Te uniste — listo para publicar", didYouJoin:"¿Te uniste al grupo?", iJoined:"Me uní →",
    choosePhotoTitle:"Paso 3 — Elige Tu Foto", choosePhotoSubtitle:"Elige una foto real tuya. Tu cara debe ser claramente visible.",
    postItTitle:"Paso 4 — Publícala", postItSubtitle:"Estás listo. Sigue estos pasos exactamente.",
    postSteps:["Abre el grupo de Facebook y toca Escribir algo","Pega tu publicación copiada","Adjunta tu foto","Toca Publicar"],
    submitTitle:"Paso 5 — Enviar para Revisión", submitSubtitle:"Pega la URL de tu publicación o sube una captura para que tu coach pueda verificarla.",
    crossPostTitle:"Paso 6 — Publicar en 9 Grupos Más", crossPostSubtitle:"Misma publicación. Misma foto. Sin edits. Llega a 10 total.",
    ...
    howMany:"¿En cuántos grupos adicionales publicaste?", howManySub:"Ya publicaste en 1 — toca cuántos más.",
    tenDone:"¡10 Grupos Listos! →", goalTitle:"META DE LA SEMANA 1 ALCANZADA", goalDesc:"10 grupos. 10 publicaciones. Misión cumplida.", openLeads:"Abrir Engagement de Leads →",
    leadsTitle:"Sesión Completa — Ahora Ejecutamos", leadsSubtitle:"Mira este video de capacitación antes de trabajar tus leads.",
    watchedBtn:"✓ Vi el video — muéstrame el playbook", alreadyWatched:"¿Ya lo viste?", skipBtn:"Omitir →",
    notBuilt:"Aún no has construido tu historia.", notBuiltDesc:"Completa los 3 capítulos para generar tu publicación — o pega una existente abajo.",
    writeMyPost:"✍️ Escribir Mi Publicación", pastePost:"Pega tu publicación de Facebook aquí...", usePost:"Usar Esta Publicación →",
    devShortcuts:"Atajos de desarrollo", fillSample:"Llenar Respuestas de Muestra", skipStop:"Ir a Pantalla de Pausa", skipGroups:"Ir a Grupos", skipLeads:"Ir a Leads",
    searchCity:"¿Qué ciudad o área sirves?", cityPlaceholder:"ej. Este de Nashville", search:"Buscar",
    coachAccess:"Acceso del Coach", enterPasscode:"Ingresa el código", incorrectPasscode:"Código incorrecto.", enterDashboard:"Entrar al Panel", cancel:"Cancelar",
    submitReview:"✅ Enviar para Revisión del Coach →", pasteOrUpload:"Pega una URL o sube una captura para continuar",
    whyNeeded:"¿Por qué necesitamos esto?", whyNeededDesc:"Tu coach necesita ver la publicación en vivo antes de aprobarla. Una URL o una captura — solo necesitas una.",
    pasteUrl:"Opción 1 — Pega la URL de tu publicación", urlAccepted:"✓ ¡URL aceptada!",
    uploadScreenshot:"Opción 2 — Sube una captura de pantalla", tapUpload:"Toca para subir captura", screenshotAccepted:"✓ ¡Captura aceptada!",
  }
};
...
const QT = {
  en:[
    ...
    {id:"whyStarted",num:9,chapter:"ch3",minWords:20,label:"Why You Started",hint:"The real moment that pushed you to start your business. Be honest and specific. Minimum 20 words.",placeholder:"e.g. I got tired of watching my old boss charge elderly customers three times what a job was worth"},
    ...
    {id:"heroCrisis",num:10,chapter:"ch3",minWords:20,label:"Hero Moment - The Crisis",hint:"Paint the full picture of who was in trouble, what the situation looked like, what was at stake. Minimum 20 words.",placeholder:"e.g. An elderly woman called me at 7pm on Christmas Eve, her heat had been out for two days"},
  ...
  es:[
    ...
    {id:"humanDetail",num:6,chapter:"ch2",minWords:15,label:"Un Detalle Humano",hint:"Un detalle real sobre ti fuera del trabajo con especificidad. Mínimo 15 palabras.",placeholder:"ej. Llevo años restaurando una Ford Bronco 1967 roja que encontré oxidándose en un granero"},
    ...
    {id:"whyStarted",num:9,chapter:"ch3",minWords:20,label:"Por Qué Empezaste",hint:"El momento real que te impulsó a comenzar tu negocio. Sé honesto y específico. Mínimo 20 palabras.",placeholder:"ej. Me cansé de ver a mi antiguo jefe cobrarle tres veces más de lo debido a clientes mayores"},
    {id:"whatChanged",num:"9b",chapter:"ch3",minWords:10,label:"¿Qué Cambió?",hint:"Un cambio real y concreto en tu vida o familia desde que saliste por tu cuenta. Mínimo 10 palabras.",placeholder:"ej. Ahora llego a cenar con mi familia casi todas las noches"},
    {id:"heroCrisis",num:10,chapter:"ch3",minWords:20,label:"Momento Héroe - La Crisis",hint:"Pinta el cuadro completo de quién estaba en problemas, cómo era la situación. Mínimo 20 palabras.",placeholder:"ej. Una señora mayor me llamó a las 7pm en Nochebuena, llevaba dos días sin calefacción"},
...
const INSPO = {
  en:{
    ...
    heroCrisis:["A young mom called me on a Friday — her water heater had flooded her basement and family was coming for a birthday party the next morning","An elderly man called me in August — his AC had been out for four days during a heat advisory"],
  ...
  es:{
    ...
    topServices:["actualización de paneles e instalación de cargadores","reemplazo de calentadores y limpieza de drenajes","cuidado de jardines y limpiezas de temporada"],
    ...
    humanDetail:["Entreno al equipo de fútbol de mi hija cada sábado y no nos hemos perdido un partido en tres temporadas","Llevo dos años restaurando un Chevelle 1972 en mi garaje y mi hijo adolescente ha empezado a ayudarme los fines de semana"],
    ...
    whyStarted:["Me cansé de ver a mi antiguo jefe tratar a los clientes como si fueran tontos y un día simplemente no pude más y me fui","Después de que mi papá fue cobrado de más por un contratista decidí ser la persona en quien la gente puede confiar"],
    whatChanged:["Por fin dejé de perderme la hora de dormir de mis hijos todas las noches y entrené las ligas menores por primera vez","Mi esposa dice que ahora llego a casa sonriendo en vez de entrar agotado y derrotado"],
    heroCrisis:["Una mamá joven me llamó un viernes — el calentador había inundado su sótano y la familia llegaba para una fiesta a la mañana siguiente","Un señor mayor me llamó en agosto — su aire acondicionado llevaba cuatro días sin funcionar durante una advertencia de calor"],
...
const SAMPLE_ANSWERS = {
  ...
  heroCrisis:"An elderly woman called me at 7pm on Christmas Eve her heat had been out for two days and she had her three grandkids coming in from out of town the next morning and she was in tears on the phone",
...
const LEAD_TYPES = [
  {id:"like",emoji:"👍",label:"Like or Emoji",color:"#FEF9EC",border:YELLOW,simple:true,steps:[
  ...
  {id:"share",emoji:"🔁",label:"Share",color:"#F0FDF4",border:"#86EFAC",simple:true,steps:[
...
async function findFacebookGroups(city, count) {
  ...
  try { const p = JSON.parse(match[0]); if (!Array.isArray(p)) return []; return p.filter(g=>g.name).map(g=>({...g,url:"https://www.facebook.com/search/groups/?q="+encodeURIComponent(g.name)})).sort((a,b)=>a.privacy==="Public"?-1:1); } catch(e) { return []; }
}
...
async function generateAIPost(ans, lang) {
  ...
  const p = "You are a professional copywriter writing scroll-stopping neighborly Facebook posts for home service business owners.\n\n"
    ...
    +"\n\nSTRICT NO-HALLUCINATION: Every fact, person, place, and time must come directly from the answers above. Never swap or substitute any detail — if the answer says wife, write wife not kids. If it says 3 years ago, write 3 years ago not 3 seasons. You may expand short answers into vivid emotional sentences and add sensory detail, but you must anchor every expansion to what was actually provided.\n"
    +"RULES: First person only. Never use: professionalism, integrity, excellence, quality work, commitment, reliable, expert, top-notch. No em dashes. No CTA, phone, or website. Fix grammar and punctuation. 330-450 words. Short paragraphs.\n"
    ...
    +"STRUCTURE: (1) Vulnerable hook, (2) Identity anchor, (3) Hero moment 8-12 lines, (4) Neighbor proof, (5) End ONLY with: \""
    +(isEs?"También estoy en una misión para encontrar el mejor [mission] en [city]. ¿Alguna sugerencia?":"Also, I'm on a mission to find the best [mission] in [city]. Any suggestions?")
    +"\"\nOutput post only. No labels.";
  return await callClaude([{role:"user",content:p}]);
}

function getWriteStatus(answers, lang) {
  const n = QT[lang].filter(q=>wordCount(answers[q.id])>=q.minWords).length;
  if (n===0) return {label:lang==="es"?"No Iniciado":"Not Started",color:GRAY400,bg:GRAY100};
  if (n<QT[lang].length) return {label:lang==="es"?"En Progreso":"In Progress",color:"#92400E",bg:"#FEF9EC"};
...
function getNextStep(answers, post, completedSections, coachApproved, postCount, dmSent, stacked, lang) {
  const n = QT[lang].filter(q=>wordCount(answers[q.id])>=q.minWords).length;
  if (n===0) return {label:lang==="es"?"Comenzar a Escribir":"Start Writing Your Post",phase:"writechoice",emoji:"✍️"};
  if (n<QT[lang].length) { const nq=QT[lang].find(q=>wordCount(answers[q.id])<q.minWords); return {label:lang==="es"?`Continuar — ${n} de 15 listas`:`Continue Writing — ${n} of 15 done`,phase:nq?nq.chapter:"ch1",emoji:"✍️"}; }
...
// ── Shared UI ─────────────────────────────────────────────────────────────────
function Card({children,style}) { return <div style={Object.assign({background:WHITE,borderRadius:16,padding:28,boxShadow:"0 4px 24px rgba(0,41,66,0.08)",marginBottom:20},style||{})}>{children}</div>; }
...
// Consistent nav row: Back (yellow) bottom-left, Next (yellow) bottom-right
function NavRow({onBack,backLabel,onNext,nextLabel,nextDisabled}) {
  return (
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20,gap:12}}>
      <Btn onClick={onBack}>{backLabel||"← Back"}</Btn>
      {onNext && <Btn onClick={onNext} disabled={!!nextDisabled}>{nextLabel||"Next →"}</Btn>}
    </div>
  );
}
              ...
              {sectionActive&&(
                <div style={{background:GRAY50,border:"1px solid "+GRAY200,borderTop:"none",borderRadius:"0 0 10px 10px",padding:"8px 10px",display:"flex",flexDirection:"column",gap:5}}>
                  {subPhases.map((p,i)=>{
                    ...
                    return (
                      <div key={p} onClick={e=>{e.stopPropagation();onNavigate&&onNavigate(p);}} style={{padding:"3px 10px",borderRadius:99,fontSize:11,fontWeight:600,background:isDone?"#D1FAE5":isActive?YELLOW:GRAY200,color:isDone?"#065F46":isActive?NAVY:GRAY400,cursor:"pointer",textAlign:"center",transition:"all 0.2s",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>
...
function MicBtn({onTranscript,size,previewValue,onPreviewChange,lang}) {
  ...
  const sz=Math.max(size||30,44); const iconSz=Math.min(size||30,22);
  useEffect(()=>{
  ...
  function startListening(){
    ...
    recogRef.current.lang=langRef.current==="es"?"es-ES":"en-US";
    finalRef.current="";setErr("");recogRef._keepAlive=true;
  ...
  function commitAndStop(){
    ...
    setListening(false);const result=finalRef.current.trim();if(result)onTranscript(result);finalRef.current="";
...
function GroupActionRow({group,onConfirmed,t}) {
  ...
  if (confirmed) return (
    <div style={{background:"#F0FDF4",border:"1.5px solid #86EFAC",borderRadius:12,padding:"12px 16px",display:"flex",alignItems:"center",gap:12}}>
      ...
      <Btn onClick={onConfirmed} style={{fontSize:13,padding:"8px 16px"}}>Next →</Btn>
    </div>
  );
  return (
...
function EvidenceCapture({onSubmit,t}) {
  const [url,setUrl]=useState(""); const [screenshot,setScreenshot]=useState(null); const [screenshotName,setScreenshotName]=useState("");
      ...
      <div style={{marginBottom:24,padding:16,borderRadius:12,border:"2px solid "+(screenshot?GREEN:GRAY200),background:screenshot?"#F0FDF4":WHITE}}>
        ...
        {!screenshot?(
          <button onClick={()=>fileRef.current&&fileRef.current.click()} style={{width:"100%",border:"2px dashed "+GRAY200,borderRadius:10,padding:"20px 16px",background:GRAY50,cursor:"pointer",display:"flex",flexDirection:"column",alignItems:"center",gap:8}}>
            <span style={{fontSize:26}}>📸</span><span style={{fontWeight:700,color:NAVY,fontSize:14}}>{t.tapUpload}</span>
          </button>
        ):(
...
function CoachDashboard({onClose}) {
  const [submissions,setSubmissions]=useState([]); const [loading,setLoading]=useState(true); const [expanded,setExpanded]=useState(null);
  ...
  useEffect(()=>{loadData();},[]);
  const STATUS_BADGES=[{label:"Post Generated",bg:"#DBEAFE",fg:"#1D4ED8"},{label:"Needs Review",bg:"#FEF9C3",fg:"#854D0E"},{label:"Coach Approved",bg:"#D1FAE5",fg:"#065F46"},{label:"10 Groups Done",bg:"#F3E8FF",fg:"#6B21A8"}];
...
function WaitForCoach({answers,onContinue,onBack,lang}) {
  const t=T[lang];
  const [suggestion,setSuggestion]=useState(""); const [loading,setLoading]=useState(true);
  useEffect(()=>{
    const prompt=lang==="es"
      ?"Eres un coach de negocios. Basado en las respuestas de este Pro, dale exactamente 3 ideas de fotos — Buena, Mejor y La Mejor. Cada una debe ser una oración corta. Referencia detalles reales.\n\nNombre: "+(answers.name||"")+"\nDetalle humano: "+(answers.humanDetail||"")+"\nLugar local: "+(answers.localPlace||"")+"\nActividad local: "+(answers.localActivity||"")+"\n\nDevuelve SOLO:\nBUENA: [una oración]\nMEJOR: [una oración]\nLA MEJOR: [una oración]"
      :"You are a business coach. Give exactly 3 photo ideas — Good, Better, Best. One short punchy sentence each. Reference their actual answers.\n\nName: "+(answers.name||"")+"\nHuman detail: "+(answers.humanDetail||"")+"\nLocal place: "+(answers.localPlace||"")+"\nLocal activity: "+(answers.localActivity||"")+"\n\nReturn ONLY:\nGOOD: [one sentence]\nBETTER: [one sentence]\nBEST: [one sentence]";
    callClaude([{role:"user",content:prompt}])
      .then(r=>{setSuggestion(r);setLoading(false);})
      .catch(()=>{setSuggestion(lang==="es"?"BUENA: Una foto tuya en tu lugar favorito.\nMEJOR: Tú con un familiar haciendo algo que amas.\nLA MEJOR: Un momento real que muestra tu personalidad.":"GOOD: A solo shot of you at your favorite local spot.\nBETTER: You with a family member doing something you love.\nBEST: A candid real moment that shows your personality.");setLoading(false);});
  },[]);
  const suggestionLines=suggestion.split("\n").filter(Boolean);
  const tileColors=[{bg:"#F0FDF4",border:"#86EFAC",labelBg:GREEN,labelColor:WHITE},{bg:"#EFF6FF",border:"#93C5FD",labelBg:"#3B82F6",labelColor:WHITE},{bg:"#FEF9EC",border:YELLOW,labelBg:YELLOW,labelColor:NAVY}];
  return (
    <div>
      <div style={{background:YELLOW,borderRadius:16,padding:"24px 28px",marginBottom:20,display:"flex",alignItems:"center",gap:16,boxShadow:"0 4px 24px rgba(254,183,5,0.4)"}}>
        ...
        <div><h2 style={{color:NAVY,fontSize:24,fontWeight:900,margin:"0 0 6px"}}>{t.stopTitle}</h2><p style={{color:NAVY,fontSize:14,lineHeight:1.6,margin:0,opacity:0.8}}>{t.stopDesc}</p></div>
      </div>
      <Card>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:12,marginBottom:24}}>
          {loading?(
            ...
            const colonIdx=line.indexOf(": "); const label=colonIdx>-1?line.slice(0,colonIdx):""; const text=colonIdx>-1?line.slice(colonIdx+2):line;
...
function ProgressiveForm({answers,onAnswer,onExit,onComplete,validationFeedback,lang,initialPhase,onPhaseChange}) {
  const ALL_Q=QT[lang];
  const startIdx=ALL_Q.findIndex(q=>q.chapter===initialPhase);
  ...
  const isLastQ=idx===ALL_Q.length-1;
  const isFirstQ=idx===0;
  const totalAnswered=ALL_Q.filter(x=>wordCount(answers[x.id])>=x.minWords).length;
    ...
    <div>
      <div style={{marginBottom:12,display:"flex",alignItems:"center",gap:10}}>
        ...
        <div>
          ...
          <div style={{fontSize:12,color:GRAY400,marginTop:2}}>{totalAnswered} {t.of} {ALL_Q.length} {t.questionsAnswered}</div>
        </div>
      </div>
      <Card style={{minHeight:340,display:"flex",flexDirection:"column",overflow:"hidden"}}>
        <div style={slideStyle}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
            ...
            <MicBtn onTranscript={handleMic} size={28} previewValue={answers[q.id]||""} onPreviewChange={v=>onAnswer(q.id,v)} lang={lang}/>
          </div>
          ...
          <div style={{display:"flex",gap:12,alignItems:"center",justifyContent:"space-between"}}>
            <Btn onClick={handleBack}>{isFirstQ?t.back:"← Previous"}</Btn>
            <div style={{display:"flex",alignItems:"center",gap:10}}>
              <span style={{fontSize:12,color:GRAY400}}>{idx+1} / {ALL_Q.length}</span>
...
function LeadEngagement({onBack,onAmplify}) {
  const [watched,setWatched]=useState(false); const [active,setActive]=useState(null); const [subtype,setSubtype]=useState(null);
  const [copiedIdx,setCopiedIdx]=useState(null); const [log,setLog]=useState([]); const [jobsBooked,setJobsBooked]=useState(0);
  const [jobsInput,setJobsInput]=useState(""); const [showJobEntry,setShowJobEntry]=useState(false);
  ...
  function copyScript(text,idx){try{const el=document.createElement("textarea");el.value=text;el.style.position="fixed";el.style.opacity="0";document.body.appendChild(el);el.select();document.execCommand("copy");document.body.removeChild(el);}catch(e){navigator.clipboard&&navigator.clipboard.writeText(text);}setCopiedIdx(idx);setTimeout(()=>setCopiedIdx(null),2000);}
  ...
  function ScriptBlock({text,idx}){return(<div style={{background:GRAY50,border:"1.5px solid "+GRAY200,borderRadius:12,padding:"14px 16px",marginBottom:10}}><p style={{fontSize:14,color:GRAY800,lineHeight:1.8,margin:"0 0 10px",fontStyle:"italic"}}>"{text}"</p><button onClick={()=>copyScript(text,idx)} style={{background:copiedIdx===idx?GREEN:NAVY,color:copiedIdx===idx?WHITE:YELLOW,border:"none",borderRadius:8,padding:"7px 16px",fontSize:12,fontWeight:700,cursor:"pointer"}}>{copiedIdx===idx?"✓ Copied!":"📋 Copy Script"}</button></div>);}
  function StepLabel({num,text}){return(<div style={{display:"flex",gap:10,alignItems:"flex-start",margin:"16px 0 8px"}}><div style={{background:YELLOW,color:NAVY,borderRadius:99,width:24,height:24,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:900,fontSize:12,flexShrink:0,marginTop:1}}>{num}</div><div style={{fontWeight:700,color:NAVY,fontSize:14,paddingTop:2}}>{text}</div></div>);}
  return (
    <div>
      <div style={{marginBottom:20}}><Btn onClick={onBack}>← Back</Btn></div>
      {!watched&&(
        <Card>
        ...
        <div>
          ...
          {activeLead&&!activeLead.simple&&activeSubtype&&(
            <Card>
              ...
              <div style={{borderTop:"1px solid "+GRAY200,paddingTop:16,marginTop:16,display:"flex",gap:10}}>
                <Btn variant="success" onClick={()=>{logLead(activeLead.id);reset();}}>✓ Mark as Worked</Btn>
                <Btn onClick={()=>setSubtype(null)}>← Different Response</Btn>
              </div>
            </Card>
          )}
          {!active&&(
...
function Amplify({city,week1Total}) {
  const [groups,setGroups]=useState([]); const [loading,setLoading]=useState(false); const [error,setError]=useState(""); const [amplifyCount,setAmplifyCount]=useState(0);
  const totalPosted=(week1Total||0)+amplifyCount;
  async function fetchGroups(){if(!city||city==="Your City"){setError("Please enter your city.");return;}setLoading(true);setError("");try{const fresh=await findFacebookGroups(city,20);setGroups(fresh);if(!fresh.length)setError("No groups found. Try a nearby city.");}catch(e){setError("Could not load groups.");}setLoading(false);}
    ...
    <>
      <Card style={{background:NAVY}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:12}}>
          ...
          <div style={{background:"rgba(255,255,255,0.08)",borderRadius:12,padding:"10px 18px",textAlign:"center"}}><div style={{color:YELLOW,fontWeight:900,fontSize:28,lineHeight:1}}>{totalPosted}</div><div style={{color:GRAY400,fontSize:11,marginTop:2}}>total groups posted</div></div>
        </div>
      </Card>
      <Card>
...
export default function App() {
  ...
  const [groups5,setGroups5]=useState([]); const [groups20,setGroups20]=useState([]);
  const [groupsLoading,setGroupsLoading]=useState(false); const [groupsError,setGroupsError]=useState("");
  const [manualCity,setManualCity]=useState("");
  const [showCoachLogin,setShowCoachLogin]=useState(false); const [showDashboard,setShowDashboard]=useState(false);
  const [passcodeInput,setPasscodeInput]=useState(""); const [passcodeError,setPasscodeError]=useState(false);
  ...
  async function saveSubmission(a,generatedPost,status,evidence){
    ...
    try{
      let prev={};try{const ex=await window.storage.get(key,true);if(ex&&ex.value)prev=JSON.parse(ex.value);}catch(e){}
  ...
  async function handleGeneratePost(){
    ...
    try{
      ...
      setPost(enPost);setPostLoading(false);
  ...
  function StatusTag({status}){return <span style={{display:"inline-flex",alignItems:"center",gap:5,background:status.bg,color:status.color,borderRadius:99,padding:"3px 10px",fontSize:11,fontWeight:700}}>{status.label==="Done"||status.label==="Listo"?"✓ ":status.label==="Not Started"||status.label==="No Iniciado"?"○ ":"● "}{status.label}</span>;}

  function copyPost(){try{const el=document.createElement("textarea");el.value=post;el.style.position="fixed";el.style.opacity="0";document.body.appendChild(el);el.select();document.execCommand("copy");document.body.removeChild(el);setCopiedGetpost(true);}catch(e){navigator.clipboard&&navigator.clipboard.writeText(post).then(()=>setCopiedGetpost(true));}}
      ...
      <div ref={topRef} style={{maxWidth:680,margin:"0 auto",padding:"28px 16px 60px"}}>
        ...
        {appPhase==="lane"&&(
          <div>
            ...
            <button onClick={()=>setAppPhase(nextStep.phase)} style={{width:"100%",background:YELLOW,border:"none",borderRadius:14,padding:"18px 24px",display:"flex",alignItems:"center",justifyContent:"space-between",cursor:"pointer",marginBottom:24,boxShadow:"0 4px 20px rgba(254,183,5,0.35)"}}>
        ...
        {appPhase==="writechoice"&&(
          <div>
            <NavRow onBack={()=>setAppPhase("lane")} backLabel={t.back}/>
            <Card>
        ...
        {appPhase==="waitforcoach"&&(
          <WaitForCoach answers={answers} onContinue={()=>setAppPhase("groups")} onBack={()=>setAppPhase("ch1")} lang={lang}/>
        )}
        ...
        {appPhase==="groups"&&(
          <div>
            ...
            <NavRow onBack={()=>setAppPhase("lane")} backLabel={t.back} onNext={()=>setAppPhase("getpost")} nextLabel={t.next}/>
          </div>
        )}
        ...
        {appPhase==="getpost"&&(
          <div>
            <NavRow onBack={()=>setAppPhase("groups")} backLabel={t.back}/>
            <Card style={{marginBottom:16}}>
              <SectionHeader emoji="✍️" title={t.stepGetPost}/>
              {postLoading&&<div style={{textAlign:"center",padding:24}}><div style={{fontSize:32,marginBottom:12}}>✨</div><p style={{color:GRAY600,fontSize:14}}>{t.writingPost}</p></div>}
              {postError&&<div style={{background:"#FEF2F2",borderRadius:10,padding:14,color:RED,fontSize:13}}>{postError}</div>}
              {!postLoading&&ch3Met&&!post&&(
                <div>
                  <p style={{color:GRAY600,fontSize:14,lineHeight:1.7,marginBottom:20}}>{lang==="es"?"Tus respuestas están listas. Toca abajo y escribiremos tu publicación.":"Your story answers are ready. Tap below and we'll write your post."}</p>
                  <Btn onClick={handleGeneratePost}>{t.generatePost}</Btn>
                </div>
              )}
              {!postLoading&&!ch3Met&&(
                <div>
                  ...
                  <textarea value={post} onChange={e=>setPost(e.target.value)} rows={10} placeholder={t.pastePost} style={{width:"100%",boxSizing:"border-box",border:"2px solid "+(post?NAVY:GRAY200),borderRadius:12,padding:16,fontSize:14,lineHeight:1.8,color:GRAY800,fontFamily:"inherit",resize:"none",background:post?"#F0F7FF":GRAY50,outline:"none",marginBottom:14}}/>
                  {post&&post.trim().length>=50&&<Btn onClick={()=>setAppPhase("photo")}>{t.next}</Btn>}
                </div>
              )}
            </Card>
            {!postLoading&&ch3Met&&post&&(
              <div style={{marginBottom:20}}>
                <div style={{display:"grid",gridTemplateColumns:lang==="es"?"1fr 1fr":"1fr",gap:16,marginBottom:16}}>
                  <div>
                    {lang==="es"&&<div style={{fontWeight:700,color:NAVY,fontSize:13,marginBottom:8}}>{t.englishPost}</div>}
                    <div style={{background:WHITE,border:"2px solid "+NAVY,borderRadius:12,padding:20,fontSize:13,lineHeight:1.9,color:GRAY800,whiteSpace:"pre-wrap",boxShadow:"0 4px 24px rgba(0,41,66,0.08)"}}>{post}</div>
                  </div>
                  {lang==="es"&&(
                    <div>
                      <div style={{fontWeight:700,color:NAVY,fontSize:13,marginBottom:8}}>{t.spanishPost}</div>
                      <div style={{background:"#F8F0FF",border:"2px solid #D8B4FE",borderRadius:12,padding:20,fontSize:13,lineHeight:1.9,color:GRAY800,whiteSpace:"pre-wrap",userSelect:"none",WebkitUserSelect:"none",boxShadow:"0 4px 24px rgba(0,41,66,0.08)"}}>
                        {postEsLoading
                ...
                <div style={{display:"flex",gap:10,flexWrap:"wrap",marginBottom:14}}>
                  <Btn onClick={copyPost} variant={copiedGetpost?"success":"primary"}>{copiedGetpost?t.copied:t.copyPost}</Btn>
                  <Btn variant="secondary" onClick={handleGeneratePost} disabled={postLoading||postEsLoading}>{t.regenerate}</Btn>
                </div>
                {copiedGetpost&&(
                  <div style={{background:"#EFF6FF",border:"1.5px solid #93C5FD",borderRadius:12,padding:"14px 18px",display:"flex",alignItems:"center",justifyContent:"space-between",gap:16,flexWrap:"wrap"}}>
                    ...
                    <Btn onClick={()=>setAppPhase("photo")}>{t.next}</Btn>
                  </div>
                )}
              </div>
            )}
        ...
        {appPhase==="photo"&&(
          <div>
            ...
            <NavRow onBack={()=>setAppPhase("getpost")} backLabel={t.back} onNext={()=>setAppPhase("dopost")} nextLabel={t.next}/>
          </div>
        )}
        ...
        {appPhase==="dopost"&&(
          <div>
            ...
            <NavRow onBack={()=>setAppPhase("photo")} backLabel={t.back} onNext={()=>setAppPhase("approval")} nextLabel={t.next}/>
          </div>
        )}
        ...
        {appPhase==="approval"&&(
          <div>
            <NavRow onBack={()=>setAppPhase("dopost")} backLabel={t.back}/>
            <Card>
        ...
        {appPhase==="replicate"&&(
          <div>
            <NavRow onBack={()=>setAppPhase("approval")} backLabel={t.back}/>
            <Card>
        ...
        {appPhase==="amplify"&&(
          <div>
            <NavRow onBack={()=>setAppPhase("leads")} backLabel={t.back}/>
